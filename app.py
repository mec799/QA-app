...
with col1:
    ...
    if "ocr_result" in st.session_state:
        ...
        edited_text = st.text_area("Yapay zeka hata yapabilir eğer hatalı yazıldığını düşündüğünüz kelimeler vs varsa düzenleme yapabilirsiniz.(Dark Mode açıkken aşağıdaki metin gözükmeyebilir fakat aşağıdaki butondan flashcard oluşturmaya devam edebilirsiniz. Daha iyi deneyim için Light Mode kullanın)", value=st.session_state["ocr_result"], height=300, key="text_area")
